...
public class BrontoAttackGoal extends MeleeAttackGoal {

    private final BrontoEntity entity;
    private int attackDelay = 20;
    private int ticksUntilNextAttack = 20;
    private boolean shouldCountTillNextAttack = false;

    public BrontoAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((BrontoEntity) mob);
    }
    ...
    protected void attack(LivingEntity pEnemy, double squaredDistance) {
        ...
        if (isEnemyWithinAttackDistance(pEnemy)) {
            ...
            if(isTimeToAttack()) {
                ...
                entity.playSound(ModSounds.BRONTO_ATTACK, 1.0f, entity.getSoundPitch());
            }
        } else {
            resetAttackCooldown();
